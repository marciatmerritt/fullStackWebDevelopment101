...
applicant1.programStatus = "Accepted";
/* 
...
const filterApplicantsByEligibility = (applicants) => {
    ...
    for(const applicant of applicants){
        if (isEligibleApplicant(applicant)){
            eligibleApplicants.push(applicant);
        }
    }
    return eligibleApplicants; //TODO: fill in the correct logic for this function
}
